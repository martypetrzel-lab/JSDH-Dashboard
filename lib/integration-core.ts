...
export type IntegrationServiceSource = { id: string; status: string; weekStart: Date; weekEnd: Date; needsCrewChange: boolean; crewIssue: string | null; assignments: IntegrationAssignment[]; replacements: IntegrationReplacement[] };
