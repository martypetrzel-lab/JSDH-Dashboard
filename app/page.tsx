...
export default async function Home() {
  ...
  return <ServiceApp adminName={session.username} initialMembers={members.map(serializeMember)} initialAbsences={absences} initialTemplateName={template?.filename ?? null} initialSettings={settings ?? undefined} initialCurrentService={service} initialConditioning={conditioning} />;
}
