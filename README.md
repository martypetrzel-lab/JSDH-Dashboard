...
Modul **Školení / Odborná příprava** eviduje témata, školitele a docházku, nabízí archiv, statistiky účasti a PDF přehledy jednotky i jednotlivých členů. Postup nasazení a používání je v [dokumentaci školení](docs/training.md). Výchozí knihovna obsahuje 222 témat Bojového a Cvičebního řádu v 15 podkategoriích.
...
10. Pre-deploy kroky přebírejte z `railway.toml`: nejprve `npx prisma migrate deploy`, potom `npm run training:topics:import`. Pokud máte vlastní přepsaný příkaz v Railway, zahrňte oba kroky v tomto pořadí.
11. Spusťte deploy.
